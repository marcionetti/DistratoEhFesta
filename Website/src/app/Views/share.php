...
<body class="text-center hold-transition login-page" style="background-image: url(<?= base_url() ?>/resources/images/ehfesta3.jpeg);background-size: 100% 100%;">
...
<!-- Header -->
  <div class="cover-container d-flex mx-auto flex-column" style="width: 100%;">
    <header class="masthead mb-auto">
      <div class="inner" style="background-color: #ffffff8f;height: 55px;">
        <h2 class="masthead-brand float-left pl-3 m-2"> Convite Compartilhado
        </h2>
        ...
        <a class="btn btn-block btn-info float-right m-2" data-toggle="modal" data-target="#modalUsuario" style="width: 140px;">
          <i class="fas fa-user mr-2"></i> Entrar
        </a>
      </div>
    </header>
...
<!-- Convite -->
  <br/>
  <div class="card card-<?php echo $StatusCor; ?> col-8 p-0">
            ...
            <div class="info-box-content">
              <div class="row" style="justify-content: space-between;margin: 5px;">
                <div class="form-group col-md-12">
                  <label style="margin: 0px !important;">Endereço<i class="fas fa-asterisk" style="font-size: 7px;color: red;vertical-align: text-top;"></i></label><br>
